...
from src.models.transforms import GaussianMixtureCDF
...
def main(args):
    ...
    plot_hist(
        ...
        color="blue",
        label="Real Data",
        save=str(save_path.joinpath(f"samples_real.png")),
    )
    ...
    # )
    mg_trans = transforms.CompositeTransform(
        [
            # Layer 2 - Spline CDF Transform
            GaussianMixtureCDF(n_features=n_features, n_components=4),
